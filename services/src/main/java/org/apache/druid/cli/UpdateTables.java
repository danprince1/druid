...
public class UpdateTables extends GuiceRunnable
{
  ...
  private static final String SEGMENTS_TABLE_ADD_LAST_UPDATED = "add-last-updated-to-segments";
  ...
  public void run()
  {
    ...
    } else if (SEGMENTS_TABLE_ADD_LAST_UPDATED.equals(action_name)) {
      dbConnector.alterSegmentTableAddLastUpdated();
    }
  }
}
