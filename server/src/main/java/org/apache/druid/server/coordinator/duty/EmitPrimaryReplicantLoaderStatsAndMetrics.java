...
public class EmitPrimaryReplicantLoaderStatsAndMetrics extends EmitClusterStatsAndMetrics
{
  ...
  public EmitPrimaryReplicantLoaderStatsAndMetrics(DruidCoordinator coordinator, String groupName, boolean isContainCompactSegmentDuty)
  {
    super(coordinator, groupName, isContainCompactSegmentDuty);
  }
